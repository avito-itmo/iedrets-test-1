...
Этот репозиторий используется для выполнения лабораторных работ (ЛР), а так же итогового курсового проекта по желанию.
...
По итогам выполнения всех шести ЛР у вас будет возможность объеденить их в **единый архитектурный документ** в файле `architecture.md`. Проект оценивается отдельно и имеет свою разбалловку.
